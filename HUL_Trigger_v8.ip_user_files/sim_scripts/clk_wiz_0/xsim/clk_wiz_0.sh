...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 mylib.clk_wiz_0 mylib.glbl -log elaborate.log
}
