...
#
# Generated by Vivado on Fri Nov 10 21:39:02 +0900 2017
...
# Design libraries
design_libs=(xil_defaultlib xpm mylib)
...
compile()
{
  ...
  vlogan -work mylib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../HUL_Skelton.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../HUL_Skelton.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts mylib.clk_wiz_0 mylib.glbl -o clk_wiz_0_simv
}
