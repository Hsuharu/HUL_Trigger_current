...
#
# Generated by Vivado on Mon Dec 25 14:36:39 +0900 2017
...
# Script info
echo -e "clk_wiz_2.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L mylib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_2 mylib.clk_wiz_2 mylib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim clk_wiz_2 -key {Behavioral:sim_1:Functional:clk_wiz_2} -tclbatch cmd.tcl -log simulate.log
}
